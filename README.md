...
<div class="book" onclick="nextPage()">
    ...
    <div class="page" id="p1">
        ...
        <div class="note">
            สุขสันต์วันเกิด ย้อนหลังนะครับ นานี่ 💙<br><br>
           🎂💫
ขอให้ปีนี้เป็นปีที่ สวยแพง ดวงเฮง งานปัง เงินเข้าไม่พัก 💸✨
ไม่ว่าจะหยิบจับอะไรก็ปังทุกโปรเจกต์
คนรัก คนเอ็นดู คนซัพพอร์ต เข้ามารัวๆ 💕

ขอให้สุขภาพแข็งแรง หัวใจแฮปปี้
ยิ้มเมื่อไหร่ โลกต้องสดใสเมื่อนั้น 🌈
เป็นนานี่เวอร์ชันที่เลิศกว่าเดิม ออร่าจับทุกองศา ✨👑

ช้าแต่ปัง ช้าแต่จริงใจ
ย้อนหลังแต่ความรักให้แบบไม่ย้อนหลังนะครับ 💖🥂 💋💐   
        </div>
